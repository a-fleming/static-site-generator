...
def main():
    ...
    src_dir = "static"
    dest_dir = "docs" # used for GitHub pages
    copy_directory_contents(src_dir, dest_dir, remove_dest=True, verbose=True)
    
    content_path = "content"
    template_path = "template.html"
    dest_path = "docs" # used for GitHub pages
    if generate_pages_recursive(content_path, template_path, dest_path, basepath, verbose=False):
        print(f"Successfully generated page from '{content_path}' to '{dest_path}' using '{template_path}'")
    else:
